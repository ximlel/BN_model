%comput Roe mean
function dE_s=E_s_correct(S_sM,lo_g1,u_g1,p_g1,lo_s1,p_s1,phi_s1,lo_g2,u_g2,p_g2,lo_s2,p_s2,phi_s2,ratio_t_x)
...
E_sum = phi_g2*E_g2+phi_s2*E_s2;
E_sum = E_sum + KL*(phi_s1*(p_s1+E_s1)-phi_s2*(p_s2+E_s2))+ratio_t_x*(phi_g1*u_g1*(p_g1+E_g1)-phi_g2*u_g2*(p_g2+E_g2));
