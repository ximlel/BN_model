%comput Roe mean
function [phi_s_out,dE_g,dm_g]=E_s_correct2(S_sM,lo_g1,u_g1,p_g1,lo_s1,p_s1,phi_s1,lo_g2,u_g2,p_g2,lo_s2,p_s2,phi_s2,ratio_t_x)
...
E_gsum = phi_g2*E_g2 + KL*p_g2*(phi_s1-phi_s2)+ratio_t_x*(phi_g1*u_g1*(p_g1+E_g1)-phi_g2*u_g2*(p_g2+E_g2));
...
m_gsum = phi_g2*lo_g2*u_g2+ratio_t_x*(phi_g1*lo_g1*u_g1^2-phi_g2*lo_g2*u_g2^2+phi_s2*(p_g1-p_g2));
%Riemann invariants
...
m_gM = phi_g1*lo_g1*(u_g1-S_sM)+phi_gM*lo_gM*S_sM;
dm_g = m_gM-m_gsum;
end
