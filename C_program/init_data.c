...
void init_data_1(double * Z_g, double * U_RHO_g, double * U_U_g, double * U_V_g, double * U_E_g,
...
void init_data_2(double * Z_g, double * U_RHO_g, double * U_U_g, double * U_V_g, double * U_E_g,
                 double * U_RHO_l, double * U_U_l, double * U_V_l, double * U_E_l)
{
	double RHO_g[4], U_g[4], V_g[4], P_g[4], RHO_l[4], U_l[4], V_l[4], P_l[4];
	config[6] = 1.67;
...
void init_data_3(double * Z_g, double * U_RHO_g, double * U_U_g, double * U_V_g, double * U_E_g,
                 double * U_RHO_l, double * U_U_l, double * U_V_l, double * U_E_l)
{
	double RHO_g[4], U_g[4], V_g[4], P_g[4], RHO_l[4], U_l[4], V_l[4], P_l[4];
	config[6] = 1.4;
