function [h_mid,u_mid,H_t_mid,F,W_int]=GRP_solver_inflow(q_star,h_R,dh_R,u_R,du_R,Z,dZ_L,dZ_R,d_t)
    global ep;
    global g;
    F=zeros(2,1);
    put_out=linear_GRP_solver_inflow_SWE([q_star,h_R,dh_R,u_R,du_R,Z,dZ_L,dZ_R,g,ep]);
